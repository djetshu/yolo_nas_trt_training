...
from mod_image import visualize_image
from yolo_mem import allocate_buffers, load_engine
...
class InferenceSession:
    ...
    @staticmethod
    def show_predictions_from_batch_format(image, predictions, CLASSES_DETECTION):
